...
public class BasicMinerVoitingClient { //extends BasicChainClient {
...
//        Queue<blockchain.mining.BasicMinerClient.MiningTask> tasks = new LinkedList<>();
//        MediaAddress blockChainClient;
//
//        volatile int lastKnownNetworkComplexity;
//        volatile Block lastKnownBlock;
//
//        public BasicMinerVoitingClient() {
//            super();
...
//            blockchain.mining.BasicMinerClient.MiningTask task = getTaskFor(x -> x.transactions == transactions);
//            if (task != null) {
...
////        }
////        sendCandidates();
//            while (!tasks.isEmpty() && tasks.peek().state == blockchain.mining.BasicMinerClient.MiningTaskState.COMPLETED) {
//                tasks.poll();
//            }
//            if (!tasks.isEmpty()) {
//                tasks.peek().proceed();
...
//        }
//
//        public blockchain.mining.BasicMinerClient.MiningTask getTaskFor(Predicate<blockchain.mining.BasicMinerClient.MiningTask> test) {
//            return tasks.stream().filter(test).findFirst().orElse(null);
//        }
//
//        public boolean hasTaskFor(Predicate<blockchain.mining.BasicMinerClient.MiningTask> test) {
...
//
//            blockchain.mining.BasicMinerClient.MiningTask tsk;
//            switch (pack.kind) {
...
//                    tasks.add(new blockchain.mining.BasicMinerClient.MiningTask(pack.sender, pack.transactions));
//                    break;
//
...
//            Block block;
//            BasicMiner miner;
//            volatile blockchain.mining.BasicMinerClient.MiningTaskState state;
//            volatile int lastKnownNetworkComplexity;
//            volatile Block lastKnownBlock;
//
...
//                this.lastKnownBlock = blockchain.mining.BasicMinerClient.this.lastKnownBlock;
//                this.lastKnownNetworkComplexity = blockchain.mining.BasicMinerClient.this.lastKnownNetworkComplexity;
//                state = blockchain.mining.BasicMinerClient.MiningTaskState.STANDBY;
//            }
//
//
...
//                if (state == blockchain.mining.BasicMinerClient.MiningTaskState.BLOCK_FOUND && this.block == block) {
//                    state = blockchain.mining.BasicMinerClient.MiningTaskState.COMPLETED;
//                }
//            }
//
...
//                this.lastKnownBlock = blockchain.mining.BasicMinerClient.this.lastKnownBlock;
//                this.lastKnownNetworkComplexity = blockchain.mining.BasicMinerClient.this.lastKnownNetworkComplexity;
//                if (state == blockchain.mining.BasicMinerClient.MiningTaskState.WAIT_FOR_NETWORK_PARAMETERS_UPDATE) {
//                    state = blockchain.mining.BasicMinerClient.MiningTaskState.STANDBY;
//                }
////            startMiningIfReady();
//            }
...
//                stopMining();
//                if (state == blockchain.mining.BasicMinerClient.MiningTaskState.WAIT_FOR_RESIGN) {
//                    state = blockchain.mining.BasicMinerClient.MiningTaskState.STANDBY;
//                }
...
//                if (state != blockchain.mining.BasicMinerClient.MiningTaskState.WAIT_FOR_RESIGN & state != blockchain.mining.BasicMinerClient.MiningTaskState.WAIT_FOR_NETWORK_PARAMETERS_UPDATE) {
//                    if (lastKnownBlock == null) {
//                        requestUpdateOnNetworkParameters();
//                        state = blockchain.mining.BasicMinerClient.MiningTaskState.WAIT_FOR_NETWORK_PARAMETERS_UPDATE;
//                    } else if (!isValidTransactionPack(transactions)) {
////                    resetTransactionsIds();
//                        requestTransactionsResign(transactions);
//                        state = blockchain.mining.BasicMinerClient.MiningTaskState.WAIT_FOR_RESIGN;
//                    }
//                }
//            }
//
//            public void transitToMining() {
//                if (state == blockchain.mining.BasicMinerClient.MiningTaskState.STANDBY) {
//                    state = blockchain.mining.BasicMinerClient.MiningTaskState.MINING;
...
//                if (this.miner == miner) {
//                    state = blockchain.mining.BasicMinerClient.MiningTaskState.BLOCK_FOUND;
//                    this.block = block;
//                    stopMining();
